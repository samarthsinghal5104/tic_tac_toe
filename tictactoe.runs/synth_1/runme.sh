...
HD_PWD='F:/vivado/tictactoe/tictactoe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tic_tac_toe_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tic_tac_toe_game.tcl
